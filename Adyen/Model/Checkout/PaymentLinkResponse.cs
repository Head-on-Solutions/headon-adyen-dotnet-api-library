...
namespace HeadOn.Classic.Adyen.Model.Checkout
{
    ...
    public partial class PaymentLinkResponse : IEquatable<PaymentLinkResponse>, IValidatableObject
    {
        ...
        /// <param name="splits">An array of objects specifying how the payment should be split between accounts when using HeadOn.Classic.Adyen for Platforms. For details, refer to [Providing split information](https://docs.adyen.com/marketplaces-and-platforms/processing-payments#providing-split-information)..</param>
        ...
        /// <summary>
        /// An array of objects specifying how the payment should be split between accounts when using HeadOn.Classic.Adyen for Platforms. For details, refer to [Providing split information](https://docs.adyen.com/marketplaces-and-platforms/processing-payments#providing-split-information).
        /// </summary>
        /// <value>An array of objects specifying how the payment should be split between accounts when using HeadOn.Classic.Adyen for Platforms. For details, refer to [Providing split information](https://docs.adyen.com/marketplaces-and-platforms/processing-payments#providing-split-information).</value>
